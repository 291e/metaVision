	...
	return (
		<div className="bg-white flex flex-col gap-10 text-black">
					...
					<div className="flex flex-col text-5xl font-bold text-white  lg:text-left max-lg:text-3xl pt-10">
						...
						<div className="flex flex-shrink gap-6 pt-10 max-md:flex-col items-center max-md:items-start">
							...
							<div className="flex flex-col gap-4">
								<Link href="https://apps.apple.com/us/app/meta360/id6502634260" target="blink">
			...
			<div className="pb-4 relative">
				<Image className="absolute z-10 -top-20 hidden" src={real} alt="real" width={0} height={0} />
			...
			<div className="w-full mt-24 lg:mt-0">
				<div className="flex flex-col lg:flex-row mx-auto my-10 gap-32 items-center px-10">
					<div>
						<Image src={main2} alt="shoose" width={0} height={0} />
					</div>
					<div className="max-w-[454px] flex flex-col gap-8 items-center lg:items-start">
						<span className="w-full">
							리얼메타는 메타뱅크가 제공하는 메타비전 S/W를 이용해 3D 모델링 데이터를 복원하고, 복원된 3D
							데이터를 전 세계 사용자들이 무료 또는 유료로 자유롭게 공유할 수 있는 3D 데이터 공유
							플랫폼입니다.
						</span>
						<button className="bg-meta text-white p-2 rounded-lg lg:hidden">지금 바로 시작하기</button>
						...
						<div className="flex flex-col w-full *:w-full *:text-center *:py-3 *:lg:text-left *:lg:pl-3">
							{[
								...
								<span key={index} className={`${index % 2 === 0 ? "bg-neutral-100" : ""}`}>
									{text}
								</span>
							))}
						</div>
			...
			<div>
				<div className="flex flex-col lg:flex-row items-center  lg:justify-center lg:gap-20 bg-neutral-50 py-10">
					<div className="flex flex-col gap-4 items-center">
						...
						<Image className="pt-10" src={metaver} alt="model" width={0} height={0} />
					</div>
